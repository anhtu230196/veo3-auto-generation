<!-- BAN SAO. NGUON DUY NHAT LA .claude/skills/nano-banana-image-prompts/SKILL.md -->
<!-- Dong bo 2026-09-12. Truoc do ban nay CU HON 67 DONG va thieu han ba luat cua ngay -->
<!-- 12-09: ngoai le dung anh tu lieu cho noi chon co that, cach prompt bang chip @, va -->
<!-- quy trinh nhan vat nua than + mat don gian + sinh toan than tu asset. Review noi dung -->
<!-- cua Codex (coordination/reviews/nano-banana-prompt-content-2026-09-12.md muc 6) doc -->
<!-- dung ban cu nay, nen mot phan nhan xet dua tren luat da doi. Sua skill o dau thi PHAI -->
<!-- chep lai sang day. -->
<!-- Dong bo lai 2026-09-13: them muc 4d (8 luat rut tu case A1, Tu yeu cau chep truoc khi luong img-skill-a1-lessons settled) + banner dau file. -->
<!-- Dong bo lai 2026-09-13 chieu: them muc 4d-bis (moi cau nhieu anh nhat co the, luong img-skill-nhieu-anh-moi-cau settled), sua 4c va 4d. -->
<!-- Dong bo lai 2026-09-13 toi: Tu chap nhan chu trong anh ban do (4d-bis 4a, 4c, 6i). -->
